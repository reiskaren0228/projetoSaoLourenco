...
var PEA_SHEET_URL = 'https://docs.google.com/spreadsheets/d/1FZu_rbziDLAEbBOR8rbU_ae6tyIJYmqu/export?format=xlsx';
var GESTORES_ADJUNTOS_SHEET_URL = 'https://docs.google.com/spreadsheets/d/1BvwvlQLcS1nk57j6S8542ZxZSQ3ahwAr6czyg2VLxjk/export?format=xlsx';
var BASE_DE_DADOS_SHEET_URL = 'https://docs.google.com/spreadsheets/d/18ugxh4_z4-Z2_kWt7g4LnRNzzqlN8dbn/export?format=xlsx';
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, axios.default.get(sheetUrl, { responseType: 'arraybuffer' })];
                case 1:
                    response = _a.sent();
                    ...
                    console.log("Convers\u00E3o de ".concat(sheetName, " para ").concat(jsonFilePath, " conclu\u00EDda com sucesso!"));
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    console.error("Erro ao processar a planilha ".concat(sheetName, ":"), error_1);
                    return [3 /*break*/, 3];
